---
coderbyte: https://coderbyte.com/editor/sharing:KEWLnxZg
greenhouse: https://app2.greenhouse.io/guides/4679952002/people/153900582002?application_id=165488827002#resume
---
...
- **🏷️Tags** :  #07-2023 #company #c3 #c3-ai 
...
You are given an non-negative integer array represnting an elevation map (the width of each bar is 1). Return the maximum amount of water the container can store.
...
height1 = [1,8,6,2,5,4,8,3,7] ? [left_bound, right_bound] --> left_bound? right_bound?
#  left_bound = 8 @ index 1
#  right_bound = 7 @ index 8
#  sitting at index 2 --> value of 6
#  0
#  
height2 = [3, 0, 2, 0, 4]
height3 = [8, 6] -> 0
...
def maxArea(l):
  ...
  for i in range(len(l)):
    for j in range(i+1, len(l), 1):
      this_area = min(l[i], l[j]) * (j - i)
      best_area = max(best_area, this_area)
...
# assert maxArea(height2) == 7

## example: state i @ index 1
