...
def configure(repl):
    ...
    # repl.use_code_colorscheme(_custom_ui_colorscheme)
...
_custom_ui_colorscheme = {
    # Blue prompt.
    "prompt": "bg:#a3c9f9 #000000 bold",
    # Make the status toolbar light pink.
    "status-toolbar": "bg:#ffafcc #000000",
    # General styles.
    "completion-menu.completion": "bg:#e6f7ff #000000",
    "completion-menu.completion.current": "bg:#7eaedc #ffffff",
    "completion-menu.meta": "bg:#e6f7ff #999999",
    "completion-menu.meta.completion.current": "bg:#7eaedc #ffffff",
    "completion-menu.multi-column-meta": "bg:#e6f7ff #999999",
    "completion-menu.multi-column-meta.completion.current": "bg:#7eaedc #ffffff",
    "completion-toolbar": "bg:#e6f7ff #000000",
    "scrollbar.background": "bg:#e6f7ff",
    "scrollbar.button": "bg:#7eaedc",
    # Light blue for matching brackets.
    "matching-bracket.cursor": "bg:#a3c9f9 #000000 bold",
    "matching-bracket.other": "bg:#a3c9f9 #000000 bold",
}
