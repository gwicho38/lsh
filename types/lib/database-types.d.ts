 ...
 */
export declare function isDbOrganizationRecord(value: unknown): value is DbOrganizationRecord;
/**
 * Type guard to check if a value is a valid DbUserRecord.
 */
export declare function isDbUserRecord(value: unknown): value is DbUserRecord;
/**
 * Type guard to check if a value is a valid DbSecretRecord.
 */
export declare function isDbSecretRecord(value: unknown): value is DbSecretRecord;
/**
 * Parse tags from database - handles both string JSON and array formats.
 */
export declare function parseDbTags(tags: string | string[] | null | undefined): string[];
/**
 * Safely parse an ISO timestamp string to Date.
 * Returns null for null/undefined input.
 */
export declare function parseDbTimestamp(timestamp: string | null | undefined): Date | null;
/**
 * Safely parse an ISO timestamp string to Date.
 * Returns current date for null/undefined input.
 */
export declare function parseDbTimestampRequired(timestamp: string | null | undefined): Date;
