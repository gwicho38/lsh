...
export declare const ENV_VARS: {
    ...
    readonly LSH_METRICS_ENABLED: "LSH_METRICS_ENABLED";
    readonly LSH_METRICS_INTERVAL: "LSH_METRICS_INTERVAL";
    readonly LSH_METRICS_EXPORT_FORMAT: "LSH_METRICS_EXPORT_FORMAT";
    readonly LSH_METRICS_RETENTION: "LSH_METRICS_RETENTION";
    readonly LSH_PROFILING_ENABLED: "LSH_PROFILING_ENABLED";
    readonly LSH_PROFILING_SAMPLE_RATE: "LSH_PROFILING_SAMPLE_RATE";
...
export declare const DEFAULTS: {
    ...
    readonly METRICS_EXPORT_FORMAT: "prometheus";
    readonly PROFILING_SAMPLE_RATE: 0.1;
