...
import * as c3thin from 'c3-thin';
import type { AsyncThinTypeSystemi as AsyncThinTypeSystemV7 } from "c3-thin";
// import type { AsyncThinTypeSystem as AsyncThinTypeSystemV8 } from "@c3/c3-remote";
...
export class CliClient {
  ...
  async getTypeSystem(): Promise<unknown> {
    ...
    switch (this.version) {
      case ServerVersions.V7:
        ServerConnectionV7 = c3thin.ServerConnection;
  ...
  async sendTypeRequest(
    ...
    //   } else if (this.version === ServerVersions.V8) {
        ...
        return Promise.resolve(await console.log("hi"));
      } else {
